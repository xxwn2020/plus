                    ...
                    <div class="perfect_row mb30">
                        <form action="#">
                            ...
                            <div class="account_form_row">
                                ...
                                <div class="input">
                            <span>
                                <input @if($user['sex'] == 1) checked="checked" @endif id="male" name="sex" type="radio"
                                       value="1"/>
                                <label for="male">男</label>
                            </span>
                                    <span>
                                <input @if($user['sex'] == 2) checked="checked" @endif id="female" name="sex"
                                       type="radio" value="2"/>
                                <label for="female">女</label>
                            </span>
                                    <span>
                                <input @if($user['sex'] == 0) checked="checked" @endif id="secret" name="sex"
                                       type="radio" value="0"/>
                            ...
                            <div class="account_form_row" style="position:relative">
                                ...
                                <input id="location" name="location" type="text" value="{{$user['location'] ?? ''}}"
                                       placeholder="请输入地区搜索（例如：成都）"/>
...
@section('scripts')
    ...
    <script>
      ...
      function location_search (event) {
        ...
        axios.get('/api/v2/locations/search', { params: { name: val } }).then(function(response) {
          ...
          CropAvatar.prototype = {
            ...
            click: function() {
              if (this.fileUpload.mime_type) {
                ...
                var options = {
                  width: data.width < 500 ? data.width : 500,
