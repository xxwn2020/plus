...
@section('content')
    ...
    <div class="right_container">
        <div class="right_about">
            ...
            <ul class="auth_fans">
                <li><a href="{{ route('pc:follower', ['user_id' => $user['id']]) }}">粉丝<span>{{ $user['extra']['followers_count'] }}</span></a></li>
                <li><a href="{{ route('pc:following', ['user_id' => $user['id']]) }}">关注<span>{{ $user['extra']['followings_count'] }}</span></a></li>
            </ul>
        </div>
        {{-- 推荐用户 --}}
