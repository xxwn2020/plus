...
class AdvertisingController extends Controller
{
    ...
    public function storeAd(Request $request)
    {
        ...
        $model->data = $this->formatData($space, $formData['data'],
            $formData['type']);
    ...
    public function updateAd(Request $request, Advertising $ad)
    {
        ...
        $ad->data = $this->formatData($space, $formData['data'],
            $formData['type']);
    ...
    {
        $rules = collect($space->rule[$request->input('type')])
        ...
        $messages = collect($space->message[$request->input('type')])
    ...
    {
        $items = AdvertisingSpace::select([
            'id', 'space', 'alias', 'format', 'allow_type',
        ])->get();
