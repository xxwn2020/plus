    ...
    <el-main>
      <el-form :model="user" ref="form" label-width="80px">
        ...
        <el-form-item label="手机号">
          <el-input size="mini" v-model="user.phone"></el-input>
        </el-form-item>
        ...
        <el-form-item label="用户角色">
          <el-checkbox-group v-model="selecedRoles" size="mini">
            <el-checkbox
              :border="true"
              v-for="role in roles"
              :key="role.id"
        ...
        <el-form-item>
          <el-button size="mini" type="primary" v-loading="loading" @click="updateUser">修改</el-button>
          <el-button size="mini" @click="goBack(true)">取消</el-button>
        </el-form-item>
      </el-form>
    </el-main>
  </el-card>
